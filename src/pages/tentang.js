...
function Tentang() {
    return (
        <Container>
            <Row className="mt-5">
                <h1 className='text-center' style={{fontFamily: 'Poopins'}}>Tentang</h1>
                ...
                <Col md={6}>
                    ...
                    >
                        <p style={{ fontWeight: 'bold', fontFamily: 'Poopins' }}>Sejarah</p>
                ...
                <Col md={6}>
                    <motion.div
                        ...
                        style={{ fontFamily: 'Arial, sans-serif' }}
                    >
                        <p style={{ fontWeight: 'bold', fontFamily: 'Poopins' }}>Tujuan</p>
                        <ol>
